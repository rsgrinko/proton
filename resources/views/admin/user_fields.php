...
<div class="card" style="margin-top: 16px;">
    <p class="muted small">
        Кастомные поле профиля без правки кода и миграций: ИД счётчика, табельный номер,
        что угодно. Появляется сразу у каждого пользователя и доступно к заполнению в профиле.
    </p>

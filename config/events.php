 ...
 *   user.login        — вошёл
 *   user.logout       — вышел
 *   http.responded    — ответ на запрос собран (после прослоек и контроллера,
 *                        до записи метрик) — сюда, а не патчем Kernel::handle(),
 *                        если нужно что-то сделать после каждого запроса

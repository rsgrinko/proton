...
return [
    ...
    ['key' => 'users',       'label' => 'Пользователи', 'route' => 'admin.users',     'permission' => Permission::USERS_VIEW . '|' . Permission::USERS_MANAGE, 'group' => 2],
    ['key' => 'user-fields', 'label' => 'Поля профиля', 'route' => 'admin.userFields', 'permission' => Permission::USERS_MANAGE, 'group' => 2],
    ['key' => 'roles',       'label' => 'Роли',         'route' => 'admin.roles',     'permission' => Permission::ROLES_VIEW . '|' . Permission::ROLES_MANAGE, 'group' => 2],
    ['key' => 'tokens',      'label' => 'Ключи API',    'route' => 'admin.tokens',    'permission' => Permission::TOKENS_VIEW . '|' . Permission::TOKENS_MANAGE, 'group' => 2],

    ['key' => 'webhooks', 'label' => 'Вебхуки',      'route' => 'admin.webhooks', 'permission' => Permission::WEBHOOKS_VIEW . '|' . Permission::WEBHOOKS_MANAGE . '|' . Permission::WEBHOOKS_DELETE, 'group' => 3],
    ['key' => 'settings', 'label' => 'Настройки',    'route' => 'admin.settings', 'permission' => Permission::SETTINGS_VIEW . '|' . Permission::SETTINGS_MANAGE, 'group' => 3],
    ['key' => 'backups',  'label' => 'Копии',        'route' => 'admin.backups',  'permission' => Permission::BACKUPS_VIEW . '|' . Permission::BACKUPS_MANAGE, 'group' => 3],
    ['key' => 'queue',    'label' => 'Очередь',      'route' => 'admin.queue',    'permission' => Permission::QUEUE_VIEW . '|' . Permission::QUEUE_MANAGE, 'group' => 3],
    ['key' => 'security', 'label' => 'Безопасность', 'route' => 'admin.security', 'permission' => Permission::SECURITY_VIEW . '|' . Permission::SECURITY_MANAGE, 'group' => 3],
